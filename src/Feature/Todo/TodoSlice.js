...
//Slice is not export like that
export const {addTodo, removeTodo} = TodoSlice.actions    //individually exporting reducer bcoz they need in components
export default TodoSlice.reducer                          //our store need list of all reducer to get info of all the methods like (addTodo,removeTodo etc) hence we export reducers too
